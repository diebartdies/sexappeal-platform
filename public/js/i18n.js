...
const translations = {
    'es': {
        ...
        'Sends the welcome invitation to pending leads at a slow, human-like pace of 4 messages per hour (one per 15-minute quarter, at a random minute). It runs inside the app using the linked WhatsApp and stops automatically when no pending leads remain.': 'Envía la invitación de bienvenida a los contactos pendientes a un ritmo lento y humano de 4 mensajes por hora (uno por cada cuarto de 15 minutos, en un minuto al azar). Funciona dentro de la app usando el WhatsApp vinculado y se detiene automáticamente cuando no quedan contactos pendientes.',
        'Start sending 4/h': 'Iniciar envío 4/h',
